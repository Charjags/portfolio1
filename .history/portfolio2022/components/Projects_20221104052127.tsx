        ...
        {projects?.map((project, i)=>(
            <div className="w-screen flex-shrink-0 snap-center flex flex-col space-y-2 itmes-center justify-center p-[3rem]  md:p-44 h-screen ">
                ...
                src={urlFor(project?.image).url()}
                 alt="" 
                 />
                <div className='space-y-10 px-0 md:px-10 max-w-xl text-xs sm:pb-4 md:text-md flex lg:pl-8 lg:mx-auto justify-center text-center lg:pb-4'><span className='text-[#64ffda]'>{project.linkToBuild}</span></div>
