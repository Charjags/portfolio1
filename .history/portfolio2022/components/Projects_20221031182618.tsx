        ...
        {projects.map((project, i)=>(
            ...
            <div className="space-y-10 px-0 md:px-10 max-w-xl flex-col flex lg:pl-8 lg:mx-auto">
                <h4 className="mb-[-20px] lg:text-xl md:text-2xl sm:text-xl font-semibold text-center">
                    <span className="underline decoration-[#F7Ab0A]/50">Case Study {i+1} of {projects.length}:</span> Scriptchain Full Stack Application
                </h4>
                <p className=" overflow-y-auto max-w-[100rem] sm:pt-[-50px] md:max-w-lg  list-disc space-y-4 ml-5 lg:text-lg sm:text-md md:max-h-52 max-h-[22rem] scrollbar-thin scrollbar-thumb-[#a8b2d1]/40">
