  ...
  return (
    ...
    nx-auto items-center z-0">
        ...
        {projects?.map((project, i)=>(
            ...
            <div className="space-y-10 px-0 md:px-10 max-w-xl flex-col  lg:pl-8 lg:mx-auto">
                ...
                <p className=" sm:overflow-y-auto md:overflow-hidden max-w-[100rem] sm:pt-[-50px] md:max-w-lg  list-disc space-y-4 ml-5 lg:text-lg sm:text-md md:max-h-52 max-h-[22rem] scrollbar-thin scrollbar-thumb-[#64ffda]/40">
                {project?.summary}
                </p>
            </div>
            </div>
