...
export default function ExperienceCard1({}: Props) {
  ...
  cursor-pointer transition-opacity duration-200 overflow-hidden">
        ...
        <div className="px-0 sm:px-10">
            ...
            <img className="h-10 w-10 rounded-full"src="https://img.icons8.com/color/344/google-cloud.png" />
            ...
            <p className=" overflow-y-auto max-w-[15rem] md:max-w-lg lg:max-w-xl  list-disc space-y-4 ml-5 lg:text-lg sm:text-md max-h-52 scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#64ffda]/40">
