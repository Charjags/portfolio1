        ...
        <div className="flex flex-col md:space-y-10 space-y-8">
            ...
            <div className="space-y-10">
                <div className="flex items-center space-x-5 justify-center ">
                    <PhoneIcon className="text-[#F7AB0A] md:h-7 md:w-7 h-6 w-6 animate-pulse" />
                    <p className="text-2xl">+19726791407</p>
                </div>
                <div className="flex items-center space-x-5 justify-center">
                    <   EnvelopeIcon className="text-[#F7AB0A] md:h-7 md:w-7 h-6 w-6 animate-pulse" />
                    <p className="text-2xl">charanjagwani@live.com</p>
                </div>
                <div className="flex items-center space-x-5 justify-center">
                    <MapPinIcon className="text-[#F7AB0A] md:h-7 md:w-7 h-6 w-6 animate-pulse" />
                    <p className="text-2xl">Houston, Texas</p>
                </div>
            </div>
            <form
            ...
            >
                ...
                <button type="submit"
                className="bg-[#F7AB0A] py-5 px-10 rounded-md text-black font-bold">Submit</button>
            </form>
        </div>
    </div>
  );
