...
const Projects = ({projects}: Props) => {
  return (
    ...
    nx-auto items-center z-0">
        <h3 className="absolute top-24 uppercase tracking-[30px] text-gray-500 text-2xl">Featured Projects</h3>
        ...
        {projects?.map((project, i)=>(
            <div className="w-screen flex-shrink-0 snap-center flex flex-col space-y-2 itmes-center justify-center p-20  md:p-44 h-screen ">
                ...
                src={urlFor(project?.image).url()}
                 alt="" 
                 />
                <div className='justify-center text-center lg:pb-4'>Link to Build:&nbsp;<span className='text-[#64ffda]'>{project.linkToBuild}</span></div>
