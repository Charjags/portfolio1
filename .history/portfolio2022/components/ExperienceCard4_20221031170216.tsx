...
export default function ExperienceCard({}: Props) {
  ...
  cursor-pointer transition-opacity duration-200 overflow-hidden">
        ...
        <div className="px-0 sm:px-10">
            ...
            <img className="h-10 w-10 rounded-full" src="https://img.icons8.com/color/344/golang.png" />
            <img className="h-10 w-10 rounded-full" src="https://docs.soliditylang.org/en/v0.8.17/_static/logo.svg" />
