  ...
  return (
    <motion.div
        ...
        <h3 className="absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl">
            ...
            className="bg-[#a8d1bb] bg-opacity-20 p-10  -mb-20 mt-[8.5rem] md:mb:0 flex-shrink-0 w-56 h-56 rounded-full object-cover md:rounded-lg md:w-64 md:h-95 xl:w-[600px] xl:h-[600px]" 
            />

            <div className='space-y-10 px-0 md:px-10'>
                <h4 className='text-2xl text-[#ccd6f6] mt-[5.5rem] md:text-xl mb-[-30px] front-semibold text-justify  '>Here Is A <span className="underline decoration-[#64ffda] text-[#64ffda]"> Little</span> Bit About Me!</h4>
                <p className="sm:overflow-y-auto md:overflow-visible overflow-y-auto md:max-w-xl text-sm pb-5 text-justify text-[#a8b2d1]">
                sm:overflow-y-auto md:overflow-visible  md:max-w-lg lg:max-w-xl lg:text-lg sm:text-md max-h-96 scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#64ffda]/40
