...
const Projects = ({projects}: Props) => {
  return (
    ...
    nx-auto items-center z-0">
        <h3 className="absolute top-20 uppercase tracking-[20px] text-gray-500 text-2xl">Featured </h3>
        <h3 className="absolute top-26 uppercase tracking-[20px] text-gray-500 text-2xl">Projects </h3>
