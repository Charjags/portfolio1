  ...
  return (
    <motion.div
        ...
        <h3 className="absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl">
            ...
            className="bg-[#353c4e] p-10 pb-4 -mb-20 mt-[8.5rem] md:mb:0 flex-shrink-0 w-56 h-56 rounded-full object-cover md:rounded-lg md:w-64 md:h-95 xl:w-[600px] xl:h-[600px]" 
            />
