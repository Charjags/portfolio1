...
export default function Hero({}: Props) {
  ...
  return (
    <div className="h-screen flex flex-col space-y-8 items-center justify-center text-center overflow-hidden">
        ...
        <div className="pt-5">
          <Link href="#about">
          <button className="heroButton text-[#64ffda]">About</button>
          </Link>
          <Link href ="#experience">
          <button className="heroButton text-[#64ffda]">Experience</button>
          </Link>
          <Link href="#skills">
          <button className="heroButton text-[#64ffda]">Skills</button>
          </Link>
          <Link href="#projects">
          <button className="heroButton text-[#64ffda]">Projects</button>
          </Link>
          <Link href="#resume">
