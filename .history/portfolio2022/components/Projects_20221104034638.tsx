    ...
    nx-auto items-center z-0">
        ...
        {projects?.map((project, i)=>(
            ...
            <div className="space-y-10 px-0 md:px-10 max-w-xl flex-col flex lg:pl-8 lg:mx-auto">
                ...
                <p className="text-lg text-center md:text-left sm:overflow-y-auto md:overflow-visible sm:ml-5 lg:text-lg sm:text-md scrollbar-thin scrollbar-thumb-[#64ffda]/40">
                {project?.summary}
                </p>
