    ...
    nx-auto items-center z-0">
        ...
        {projects?.map((project, i)=>(
            <div className="w-screen flex-shrink-0 snap-center flex flex-col space-y-2 itmes-center justify-center p-20  md:p-44 h-screen ">
                ...
                viewport={{once:true}}
                className="lg:h-72 lg:w-96 mx-auto object-cover pt-9 mt-11"
                src={urlFor(project?.image).url()}
                 alt="" 
                 />
                <div className='justify-center text-center lg:pb-11'>Link to Build:&nbsp;<span className='text-[#64ffda]'>{project.linkToBuild}</span></div>
