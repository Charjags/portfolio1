...
export default function ExperienceCard({}: Props) {
  ...
  cursor-pointer transition-opacity duration-200 overflow-hidden">
        ...
        <div className="px-0 sm:px-10">
            ...
            <img className="h-10 w-10 rounded-full" src="https://img.icons8.com/fluency/48/000000/typescript--v1.png" alt='TypeScript'/>
            <img className="h-10 w-10 rounded-full" src="https://img.icons8.com/color/344/angularjs.png" alt='AngularJs'/>
            <img className="h-10 w-10 rounded-full" src="https://img.icons8.com/color/344/html-5--v1.png" alt='HTML5'/>
            <img className="h-10 w-10 rounded-full" src="https://img.icons8.com/color/344/css3.png" alt='CSS' />
            <img className="h-10 w-10 rounded-full" src="https://img.icons8.com/color/344/javascript--v1.png" alt='javaScript' />
            <img className="h-10 w-10 rounded-full" src="https://img.icons8.com/fluency/344/node-js.png" alt='NodeJS'/>
            <img className="h-10 w-10 rounded-full" src="https://img.icons8.com/color/344/amazon-web-services.png" alt='AWS' />
            <img className="h-10 w-10 rounded-full" src="https://img.icons8.com/ios/344/django.png" alt='Django'/>
