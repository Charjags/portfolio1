  ...
  return (
    <motion.div
        ...
        <h3 className="absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl">
            ...
            className="bg-[#64ffda] bg-opacity-25 p-10 pb-4 -mb-20 mt-[8.5rem] md:mb:0 flex-shrink-0 w-56 h-56 rounded-full object-cover md:rounded-lg md:w-64 md:h-95 xl:w-[600px] xl:h-[600px]" 
            />
            ...
            <div className='space-y-10 px-0 md:px-10'>
                ...
                <p className=" overflow-y-auto scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#64ffda]/40 text-sm pb-5 text-justify text-[#a8b2d1]">
