    ...
    <motion.div
        ...
        <h3 className="absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl">
            ...
            <div className='space-y-10 px-0 md:px-10'>
                ...
                <p className="overflow-y-auto  md:max-w-lg lg:max-w-xl lg:text-lg sm:text-md max-h-96 scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#64ffda]/40">
