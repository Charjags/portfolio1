...
export default function ExperienceCard({}: Props) {
  ...
  cursor-pointer transition-opacity duration-200 overflow-hidden">
        ...
        <div className="px-0 sm:px-10">
            ...
            <img className="h-10 w-10 rounded-full" src="https://img.icons8.com/color/344/angularjs.png"/>
            <img className="h-10 w-10 rounded-full" src="https://img.icons8.com/color/344/html-5--v1.png"/>
            <img className="h-10 w-10 rounded-full" src="https://img.icons8.com/color/344/css3.png" />
            <img className="h-10 w-10 rounded-full" src="https://img.icons8.com/color/344/javascript--v1.png" />
            <img className="h-10 w-10 rounded-full" src="https://img.icons8.com/fluency/344/node-js.png" />
            ...
            <ul className=" overflow-y-auto max-w-[15rem] md:max-w-lg lg:max-w-xl  list-disc space-y-4 ml-5 lg:text-lg sm:text-md max-h-52 scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#a8b2d1]/40">
