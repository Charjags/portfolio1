  ...
  return (
    <motion.div
        ...
        <h3 className="absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl">
            ...
            className="bg-[#292929] p-12 pb-3 md:hover:opacity-100 md:opacity-40-mb-20 mt-[8.5rem] md:mb:0 flex-shrink-0 w-56 h-56 rounded-full object-cover md:rounded-lg md:w-64 md:h-95 xl:w-[600px] xl:h-[600px]" 
            />

            <div className='space-y-10 px-0 md:px-10'>
                <h4 className='text-2xl mt-[5.5rem] md:text-xl mb-[-30px] front-semibold  '>Here Is A <span className="underline decoration-[#64ffda]"> Little</span> Bit About Me!</h4>
