    ...
    <motion.div
        ...
        <h3 className="absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl">
            ...
            <div className='space-y-10 px-0 md:px-10'>
                <h4 className='text-2xl text-[#ccd6f6] mt-[5.5rem] md:text-xl mb-[-30px] front-semibold text-justify max-h-96  scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#64ffda]/40 '>Here Is A <span className="underline decoration-[#64ffda] text-[#64ffda]"> Little</span> Bit About Me!</h4>
