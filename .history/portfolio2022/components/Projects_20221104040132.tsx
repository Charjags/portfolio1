  ...
  return (
    ...
    nx-auto items-center z-0">
        ...
        {projects?.map((project, i)=>(
            <div className="w-screen flex-shrink-0 snap-center flex flex-col space-y-2 itmes-center justify-center p-20  md:p-44 h-screen ">
                <motion.img 
                initial={{
                    y:-300,
                    opacity:0
                ...
                viewport={{once:true}}
                className="lg:h-72 lg:w-96 mx-auto object-cover lg:mb-9 pt-9"
            ...
            <div className="space-y-10 px-0 md:px-10 max-w-xl flex-col flex lg:pl-8 lg:mx-auto">
                ...
                <div className='justify-center text-center'>Link to Build:&nbsp;<span className='text-[#64ffda]'>{project.linkToBuild}</span></div>
                <div className='flex items-center space-x-2 mb-7 justify-center'>
                ...
                <p className="text-lg text-center md:text-left sm:overflow-y-auto md:overflow-visible sm:ml-5 lg:text-lg sm:text-md scrollbar-thin scrollbar-thumb-[#64ffda]/40 justify-center">
                {project?.summary}
                </p>
